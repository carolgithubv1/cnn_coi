...
echo "=================BEGIN===================="
# Test normal ideal with no starting weights
mkdir myresults_n41_d3_epoch100_run1_ideal_w_start   
python  -u train.py --network-width 41 --network-height 41 --network-depth 3  --epochs 100 --decay-step 1 --network-type ideal --save-every 1 --display-every 240 --device CPU --save-path myresults_n41_d3_epoch100_run1_ideal_w_start   
echo "------------------1 end-------------------"
echo "********************************************************************"
echo "***************** D3 ***********************************************"
echo "********************************************************************"
...
echo "=================BEGIN===================="
# Test normal ideal with no starting weights
mkdir myresults_n41_d5_epoch100_run1_ideal_w_start   
python  -u train.py --network-width 41 --network-height 41 --network-depth 5  --epochs 100 --decay-step 1 --network-type ideal --save-every 1 --display-every 240 --device CPU --save-path myresults_n41_d5_epoch100_run1_ideal_w_start --starting-weights Weights_Ideal_NN_Bias_COIN_BEST_41x41x5.mat
echo "------------------1 end-------------------"
echo "********************************************************************"
echo "***************** D5 ***********************************************"
echo "********************************************************************"
echo "=================BEGIN===================="
# Test normal ideal with no starting weights
mkdir myresults_n41_d7_epoch100_run1_ideal_w_start   
python  -u train.py --network-width 41 --network-height 41 --network-depth 7  --epochs 100 --decay-step 1 --network-type ideal --save-every 1 --display-every 240 --device CPU --save-path myresults_n41_d7_epoch100_run1_ideal_w_start --starting-weights Weights_Ideal_NN_Bias_COIN_BEST_41x41x7.mat
echo "------------------1 end-------------------"
echo "********************************************************************"
echo "***************** D7 ***********************************************"
echo "********************************************************************"
echo "=================BEGIN===================="
# Test normal ideal with no starting weights
mkdir myresults_n41_d9_epoch100_run1_ideal_w_start   
python  -u train.py --network-width 41 --network-height 41 --network-depth 9  --epochs 100 --decay-step 1 --network-type ideal --save-every 1 --display-every 240 --device CPU --save-path myresults_n41_d9_epoch100_run1_ideal_w_start --starting-weights Weights_Ideal_NN_Bias_COIN_BEST_41x41x9.mat
echo "------------------1 end-------------------"
echo "********************************************************************"
echo "***************** D9 ***********************************************"
echo "********************************************************************"
echo "=================BEGIN===================="
# Test normal ideal with no starting weights
mkdir myresults_n41_d11_epoch100_run1_ideal_w_start   
python  -u train.py --network-width 41 --network-height 41 --network-depth 11  --epochs 100 --decay-step 1 --network-type ideal --save-every 1 --display-every 240 --device CPU --save-path myresults_n41_d11_epoch100_run1_ideal_w_start --starting-weights Weights_Ideal_NN_Bias_COIN_BEST_41x41x11.mat
echo "------------------1 end-------------------"
echo "********************************************************************"
echo "***************** D11 **********************************************"
echo "********************************************************************"
echo "=================BEGIN===================="
# Test normal ideal with no starting weights
mkdir myresults_n41_d13_epoch100_run1_ideal_w_start   
python  -u train.py --network-width 41 --network-height 41 --network-depth 13  --epochs 100 --decay-step 1 --network-type ideal --save-every 1 --display-every 240 --device CPU --save-path myresults_n41_d13_epoch100_run1_ideal_w_start --starting-weights Weights_Ideal_NN_Bias_COIN_BEST_41x41x13.mat
echo "------------------1 end-------------------"
